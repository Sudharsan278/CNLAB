package chatAppUDPMultipleFiles;
...
public class UDPServer {
    ...
    public static void main(String[] args) {
        try (DatagramSocket serverSocket = new DatagramSocket(PORT)) {
            ...
            while (true) {
                ...
                logMessageToFile(clientName, message);
    ...
    private static void logMessageToFile(String clientName, String message) {
        String fileName = clientName + "_messages.txt";

        try (FileWriter writer = new FileWriter(fileName, true)) {
            writer.write(message + System.lineSeparator());
        } catch (IOException e) {
            System.out.println("Error writing to file for client " + clientName + ": " + e.getMessage());
        }
    }
}
