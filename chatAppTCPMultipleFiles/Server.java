...
class ClientHandler implements Runnable {
    ...
    private File clientLogFile; // File to store the client's chat messages
    ...
    public void run() {
        try {
            ...
            clientLogFile = new File(clientName + "_chat_log.txt");
    ...
    // Log a message to the client's log file
    private synchronized void logMessage(String message) {
        try (FileWriter writer = new FileWriter(clientLogFile, true)) {
            writer.write(message + System.lineSeparator());
        } catch (IOException ex) {
            System.out.println("Error logging message for client " + clientName + ": " + ex.getMessage());
        }
    }
